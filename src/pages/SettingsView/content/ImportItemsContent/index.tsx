...
export const ImportItemsContent = () => {
  ...
  const importOptions: ImportOption[] = [
    ...
    },
    {
      ...
      description: t(
        'Upload an unencrypted Lockwright export file in JSON or CSV format.'
      ),
  ...
  const onImport = async ({
    ...
    try {
      ...
      // password" (Lockwright export worklet). Everything else — malformed file,
      ...
      {state === 'default' && (
        <>
          <PageHeader
            ...
            subtitle={t(
              'Easily import your passwords and data from other password managers. Select your source, upload the exported file, and follow the prompts to get your data into Lockwright.'
            )}
          />
